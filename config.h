/* Don't be a Brainlet (10 January 2021) */
...
// background color (bottom bar black)
...
// bottom bar second color (purple) and active window border color
...
// sets default terminal emulator
